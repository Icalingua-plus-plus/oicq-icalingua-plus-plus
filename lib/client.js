...
class Client extends EventEmitter {
    ...
    getGroupNTPicRkey() {
        return this._useProtocol(image.getGroupNTPicRkey, arguments);
    }

    getOffNTPicRkey() {
        return this._useProtocol(image.getOffNTPicRkey, arguments);
    }

    getNTPicURLbyFileid() {
        return this._useProtocol(image.getNTPicURLbyFileid, arguments);
    }
