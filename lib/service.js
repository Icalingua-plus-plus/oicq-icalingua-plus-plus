...
async function getUploadChannel() {
    ...
    this.storage.ip = int32ip2str(rsp[3][2][0][2]);
    this.storage.port = rsp[3][2][0][3];
}

module.exports = {
    downloadFromWeb, highwayUploadStream, int32ip2str, highwayHttpUpload, MAX_UPLOAD_SIZE, getUploadChannel,
};
