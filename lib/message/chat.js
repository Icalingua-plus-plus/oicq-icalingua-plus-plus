...
const { highwayHttpUpload } = require("../service");
 ...
 * @this {import("../ref").Client}
 * @param {number} target 
 * @param {import("../ref").MessageElem[]|String} json 
 * @param {boolean} group 
 * @returns {import("../ref").ProtocolResponse}
 */
async function sendJsonMsg(target, json, group) {
    [target] = common.uinAutoCheck(target);
    let json_data = null;
    try {
