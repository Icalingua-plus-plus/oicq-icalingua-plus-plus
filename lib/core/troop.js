 ...
 * @param {string} data
 */
async function setButtonReaction(group_id, msg_seq, appid, id, data) {
    [group_id] = uinAutoCheck(group_id);
    const body = pb.encode({
        3: appid,
        4: msg_seq,
...
module.exports = {
    ...
    groupSign, getSignature, setGroupRemark, setFriendRemark, setEmojiReaction, setButtonReaction
};
