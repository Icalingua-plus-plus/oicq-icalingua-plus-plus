...
WtLogin.prototype.passwordLogin = async function () {
    if (this.c.config.platform !== 5 && this.apk.ssover > 12 && (!this.device.qimei16 || !this.device.qimei36)) {
        const qimei = await getQIMEI(this);
        // 缓存一下，理论上每次获取是一样的
    ...
    if (this.apk.ssover > 12) {
        writer.writeBytes(t(0x544, "810_9")) // TODO: native t544
    }
    if (this.device.qimei16) {
